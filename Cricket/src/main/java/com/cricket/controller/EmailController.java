...
import com.cricket.service.EmailService;
...
//	}
	...
	public @ResponseBody ResponseEntity<String> sendEmailAttachment(@RequestBody MailDetails mailDetails) {

		try {
			emailService.sendEmailWithAttachment(mailDetails);
